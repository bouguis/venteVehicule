						...
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
							   <form action="ajoutClient" method="get">
								...
								<div class="item-slick3" data-thumb="${auto.photo}">
									<div class="wrap-pic-w pos-relative">
										<img src="${auto.photo}" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${auto.photo}">
								...
								<div class="flex-w flex-r-m p-b-10">
									...
									<div class="size-204 respon6-next">
										<div class="rs1-select2 bor8 bg0">
											 ...
											 <input type="text" name="description" class="form-control" value="${auto.description}">
											<div class="dropDownSelect2"></div>
										</div>
									</div>
								</div>
