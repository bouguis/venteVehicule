				...
				<div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="dateCommande" placeholder="Date Commande">
						   </div>
						</div>
					</div>
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="idAuto" >
						    </div>
